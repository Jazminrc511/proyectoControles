...
Public Class Soldador
    ...
    Private Sub Soldador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CargarDatosDataGridView()
        CargarUsuariosComboBox()
    End Sub
    Private Sub CargarDatosDataGridView()
        Dim query As String = "SELECT * FROM soldadura"
    ...
    Private Sub btnRegistrar_Click(sender As Object, e As EventArgs) Handles btnRegistrar.Click
        ...
        If mensajeError = "" Then
            Dim query As String = "INSERT INTO soldadura (Usuario, Fecha, Gafas, Guantes, Casco, Mandil, Calzado, EPP) VALUES (@usuario, @fecha, @gafas, @guantes, @casco, @mandil, @calzado, @epp)"
