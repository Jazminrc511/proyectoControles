...
Partial Class menuEmpleado
    ...
    Private Sub InitializeComponent()
        btnlAlturas = New Button()
        btnElectricidad = New Button()
        btnSoldadura = New Button()
        Button3 = New Button()
        btnExcava = New Button()
        btnCerrar = New Button()
        Label1 = New Label()
        VerAcuerdo = New Button()
        usoYLimpieza = New Button()
        SuspendLayout()
        ' 
        ' btnlAlturas
        ' 
        ...
        btnlAlturas.TabIndex = 0
        btnlAlturas.Text = "EPP Trabajo en alturas"
        btnlAlturas.UseVisualStyleBackColor = False
        ' 
        ' btnElectricidad
        ' 
        ...
        btnElectricidad.TabIndex = 1
        btnElectricidad.Text = "EPP Trabajo con electricidad"
        btnElectricidad.UseVisualStyleBackColor = False
        ' 
        ' btnSoldadura
        ' 
        ...
        btnSoldadura.TabIndex = 2
        btnSoldadura.Text = "EPP Trabajo en soldadura"
        btnSoldadura.UseVisualStyleBackColor = False
        ' 
        ' Button3
        ' 
        ...
        Button3.TabIndex = 3
        Button3.Text = "EPP Trabajo Agrícola"
        ...
        btnExcava.TabIndex = 4
        btnExcava.Text = "EPP Trabajo en excavación"
        btnExcava.UseVisualStyleBackColor = False
        ' 
        ' btnCerrar
        ' 
        ...
        btnCerrar.Location = New Point(416, 828)
        btnCerrar.Name = "btnCerrar"
        btnCerrar.Size = New Size(189, 68)
        ...
        VerAcuerdo.TabIndex = 42
        VerAcuerdo.Text = "Ver acuerdo gubernativo número 229-2014"
        VerAcuerdo.UseVisualStyleBackColor = False
        ' 
        ' usoYLimpieza
        ' 
        ...
        usoYLimpieza.TabIndex = 43
        usoYLimpieza.Text = "Uso y limpieza del EPP"
        usoYLimpieza.UseVisualStyleBackColor = False
        ' 
        ' menuEmpleado
        ' 
        ...
        Controls.Add(btnExcava)
        Controls.Add(Button3)
        Controls.Add(btnSoldadura)
        Controls.Add(btnElectricidad)
        Controls.Add(btnlAlturas)
        Name = "menuEmpleado"
        Text = "Menú Empleado"
    ...
    Friend WithEvents btnlAlturas As Button
    Friend WithEvents btnElectricidad As Button
    Friend WithEvents btnSoldadura As Button
    Friend WithEvents Button3 As Button
    Friend WithEvents btnExcava As Button
    Friend WithEvents btnCerrar As Button
    Friend WithEvents Label1 As Label
    Friend WithEvents VerAcuerdo As Button
    Friend WithEvents usoYLimpieza As Button
End Class
